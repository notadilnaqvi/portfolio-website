		...
		<>
			...
			<div className="home-bottom-section">
				<div className="segment">
					...
					<p>
						I'm a mechanical engineering graduate from <br /> the #1
						science and tech university in Pakistan <br />
				...
				<div className="segment">
					...
					<p align="right">
						I'm very passionate when it comes to <br /> programming.
						I have 2 specializations and a <br /> minor in computer
						science <br />
						<a
							href="/Specializations.pdf"
							target="_blank"
				...
				<div className="segment">
					...
					<p>
						Along with some web development experience, I <br />{" "}
						have completed several machine learning and AI <br />{" "}
						projects. This website is one of my latest ones <br />
				...
				<div className="segment">
					...
					<p align="right">
						I am currently looking for opportunities that <br />{" "}
						allow me to pursue my love for coding and help <br /> me
