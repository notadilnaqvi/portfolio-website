		...
		<div className="socials">
			<ul>
				<li>
					<SocialsLink
						src={emailIcon}
						link="adilnaqvi.ug@smme.edu.pk"
						url="mailto:adilnaqvi.ug@smme.edu.pk"
				...
				<li>
					<SocialsLink
						src={skypeIcon}
						link="live:notadilnaqvi"
						url="skype:live:notadilnaqvi?chat"
						text="Give me a call"
					/>
				</li>
				<li>
					<SocialsLink
						src={githubIcon}
						link="github.com/notadilnaqvi"
						url="https://github.com/notadilnaqvi"
						text="View my code"
						copy="hide"
					/>
				</li>
				<li>
					<SocialsLink
						src={behanceIcon}
						link="behance.net/notadilnaqvi"
						url="https://www.behance.net/notadilnaqvi"
						text="See my designs"
						copy="hide"
					/>
				</li>
				...
				<li>
					<SocialsLink
						src={lichessIcon}
						link="lichess.org/@/notadilnaqvi"
						url="https://lichess.org/@/notadilnaqvi"
						text="Watch me play"
						copy="hide"
					/>
				</li>
